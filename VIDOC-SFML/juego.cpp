...
Munieco->setpersonajeimagen();
Prueba = &Munieco->getpersonaje();
...
void juego::caminar(Sprite *Alhaito){
...
case Event::KeyPressed:
    if (Keyboard::isKeyPressed(Keyboard::Right)){
        Alhaito->setPosition(Alhaito->getPosition().x + 10 ,Alhaito->getPosition().y);
    }
    if (Keyboard::isKeyPressed(Keyboard::Left)){
    Alhaito->setPosition(Alhaito->getPosition().x - 10 ,Alhaito->getPosition().y);
    }
          if (Keyboard::isKeyPressed(Keyboard::Up)){
    Alhaito->setPosition(Alhaito->getPosition().x ,Alhaito->getPosition().y - 10);
    }
          if (Keyboard::isKeyPressed(Keyboard::Down)){
    Alhaito->setPosition(Alhaito->getPosition().x ,Alhaito->getPosition().y + 10);
    };
